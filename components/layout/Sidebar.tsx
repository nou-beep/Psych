...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/research", label: "Research workspace", icon: FlaskConical },
      ...
      { href: "/thinking", label: "Thinking ✦", icon: Sparkles },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/clinical/phrases", label: "Phrase library", icon: BookMarked },
