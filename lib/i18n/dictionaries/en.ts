...
export const EN_DICT: AppDictionary = {
  ...
  collab: {
    ...
    rosterDesc:
      "Your active caseload — one dossier per team member. Search, filter by team or risk level.",
    nav: "Team members",
    navRapport: "Management report",
    newCollaborateur: "New team member",
    ...
    fields: {
      ...
      displayNameHint:
        "Use a code (e.g. COL-014) if you prefer to anonymise.",
      team: "Team",
      role: "Role",
      manager: "Manager",
      status: "Status",
    ...
    dashboard: {
      ...
      riskOverviewDesc:
        "Team members by current risk level (latest rating).",
      highNow: "Currently at high risk",
      climateTitle: "Team climate",
      climateDesc:
        "Average functioning (/10) per team — each member's latest entry, plus the trend over time.",
      fileActiveTitle: "My active caseload",
      impactTitle: "Retention & absence impact",
      impactDesc:
        "Computed only from your entries — the interpretation is yours.",
      absenceDays: "Absence days (90 d)",
      departures: "Departures (90 d)",
      riskImproved: "Risks improved (90 d)",
      activeCases: "Active dossiers",
    },
    caseTabs: {
      apercu: "Overview",
      suivi: "Tracking",
    ...
    suivi: {
      title: "Functioning tracking",
      desc: "Global functioning trend (0–10) — every point is a dated entry.",
      addEntry: "Add entry",
      functioning: "Functioning (0–10)",
      date: "Date",
      note: "Note (optional)",
      noEntries: "No entries yet.",
      absenceTitle: "Absences",
      addAbsence: "Record absence",
      absenceDays: "Days",
      ...
      departureRecorded: "Departure recorded on {date} — dossier closed.",
      cancelDeparture: "Cancel departure",
    },
    devoirs: {
      title: "Assignments",
      add: "Assign",
      fromLibrary: "From the worksheet library",
      freeText: "Or free text…",
      dueDate: "Due date",
      none: "No assignment yet.",
      markDone: "Done",
    },
    ressources: {
      ...
      label: "Label",
      note: "Note (optional)",
      none: "No resource on this dossier.",
    },
    journal: {
      title: "Contact log",
      desc: "Every contact is a dated record — the actual messaging stays in WhatsApp / SMS.",
      add: "Log a contact",
      channel: "Channel",
      channels: {
        call: "Call",
      ...
      summary: "Summary",
      seemed: "Impression (optional)",
      seemedPlaceholder: "How they seemed…",
      none: "No contact logged.",
    },
    evaluations: {
      title: "Assessments",
      desc: "Standardised grids (PHQ-9, GAD-7) and a burnout shell — manual entry, like Eyla's other grids.",
      phq9: "PHQ-9 (0–27)",
      gad7: "GAD-7 (0–21)",
      burnoutShell: "Burnout grid (MBI-style structure — manual entry, no proprietary items reproduced)",
      openAnalyse: "Enter in the analysis workspace",
    },
    rapport: {
      title: "Management report",
      desc: "Aggregated, anonymised synthesis for management — no individual data, no names, no clinical notes.",
      window: "Period",
      print: "Print",
      copy: "Copy",
      copied: "Copied.",
      empty: "Nothing to aggregate yet.",
    },
    safety: {
      title: "Data safety",
      desc: "Data lives in this browser only. Export regularly and store the file securely (encrypted) — this is employee mental-health data.",
      export: "Export data (JSON)",
      import: "Import a backup",
      importSuccess: "Backup restored.",
      importError: "Invalid file — nothing was changed.",
    },
  },
