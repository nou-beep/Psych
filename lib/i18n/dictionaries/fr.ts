...
export const FR_DICT: AppDictionary = {
  ...
  seance: {
    title: "Séance",
    workspaceTitle: "Espace séance",
    tabLabel: "Séances",
    newSeance: "Nouvelle séance",
    emptyList: "Aucune séance pour ce dossier pour le moment.",
    emptySeance: "Séance vide — rien de saisi pour l'instant.",
    status: {
      draft: "Brouillon",
      finalised: "Finalisée",
    },
    ...
    left: {
      ...
      previousSeances: "Séances précédentes",
      noPrevious: "Aucune séance précédente.",
      concerns: "Motifs de consultation",
      followUpReason: "Motif de suivi",
    },
    center: {
      observationsTitle: "Observations structurées",
      observationsSummary: "{n} domaine(s) coté(s) sur {total}",
      notesTitle: "Notes de séance",
      notesSummary: "{n} note(s)",
      addNote: "Ajouter une note",
      notePlaceholder:
        "Une note discrète — un événement, une réflexion, un verbatim…",
      noteTypes: {
        general: "Note",
      ...
      obsNotePlaceholder: "Note facultative pour ce domaine…",
    },
    right: {
      title: "Outils & mémoire",
      linkedAssessments: "Évaluations / grilles liées",
      linkedWorksheets: "Fiches de travail liées",
      resources: "Ressources",
      openSheet: "Ouvrir",
      noAssessments: "Aucune évaluation enregistrée pour ce dossier.",
      noWorksheets: "Aucune fiche de travail disponible.",
      linkedCount: "{n} liée(s)",
    },
    bottom: {
      timelineTitle: "Chronologie des séances",
      homeworkTitle: "Devoirs",
      followUpsTitle: "Actions de suivi",
      nextAppointmentTitle: "Prochain rendez-vous",
      addHomework: "Ajouter un devoir…",
      addFollowUp: "Ajouter une action de suivi…",
      appointmentDate: "Date",
      appointmentNote: "Note (facultatif)",
      noAppointment: "Aucun rendez-vous planifié.",
      currentMarker: "en cours",
    },
    assembled: {
      title: "Vue assemblée",
      desc: "Mise en forme déterministe des enregistrements de cette séance — aucune inférence, chaque ligne provient de ce que vous avez saisi.",
      copy: "Copier",
      copied: "Copié.",
    },
