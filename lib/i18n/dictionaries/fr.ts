...
export const FR_DICT: AppDictionary = {
  ...
  collab: {
    rosterTitle: "Collaborateurs",
    rosterDesc:
      "Votre file active — un dossier par collaborateur. Recherchez, filtrez par équipe ou par niveau de risque.",
    nav: "Collaborateurs",
    navRapport: "Rapport direction",
    newCollaborateur: "Nouveau collaborateur",
    ...
    seedDemo: "Charger les données de démonstration",
    clearDemo: "Effacer les données de démonstration",
    fields: {
      displayName: "Nom ou code",
      displayNameHint:
        "Utilisez un code (ex. COL-014) si vous préférez anonymiser.",
      team: "Équipe",
      role: "Poste",
      manager: "Manager",
      status: "Statut",
    ...
    risk: {
      ...
      flight: "Risque de départ",
      burnout: "Risque d'épuisement",
      ok: "Stable",
      watch: "À surveiller",
      high: "Élevé",
      none: "Non coté",
      logNew: "Coter le risque",
    },
    dashboard: {
      riskOverviewTitle: "Aperçu des risques",
      riskOverviewDesc:
        "Répartition des collaborateurs par niveau de risque actuel (dernière cotation).",
      highNow: "Actuellement à risque élevé",
      climateTitle: "Climat par équipe",
      climateDesc:
        "Fonctionnement moyen (/10) par équipe — dernière saisie par collaborateur, et tendance dans le temps.",
      fileActiveTitle: "Ma file active",
      impactTitle: "Impact rétention & absence",
      impactDesc:
        "Données calculées uniquement à partir de vos saisies — l'interprétation vous appartient.",
      absenceDays: "Jours d'absence (90 j)",
      departures: "Départs (90 j)",
      riskImproved: "Risques améliorés (90 j)",
      activeCases: "Dossiers actifs",
    },
    caseTabs: {
      apercu: "Aperçu",
      ...
      journal: "Journal de contact",
    },
    suivi: {
      title: "Suivi du fonctionnement",
      desc: "Tendance du fonctionnement global (0–10) — chaque point est une saisie datée.",
      addEntry: "Ajouter une saisie",
      functioning: "Fonctionnement (0–10)",
      date: "Date",
      note: "Note (facultatif)",
      noEntries: "Aucune saisie pour le moment.",
      absenceTitle: "Absences",
      addAbsence: "Enregistrer une absence",
      absenceDays: "Jours",
      absenceReason: "Motif (facultatif)",
      noAbsences: "Aucune absence enregistrée.",
      departureTitle: "Départ",
      recordDeparture: "Enregistrer un départ",
      departureReason: "Motif",
      departureRecorded: "Départ enregistré le {date} — dossier clos.",
      cancelDeparture: "Annuler le départ",
    },
    devoirs: {
      title: "Devoirs",
      add: "Assigner",
      fromLibrary: "Depuis la bibliothèque de fiches",
      freeText: "Ou en texte libre…",
      dueDate: "Échéance",
      none: "Aucun devoir assigné.",
      markDone: "Terminé",
    },
    ressources: {
      title: "Ressources du dossier",
      add: "Ajouter une ressource",
      label: "Intitulé",
      note: "Note (facultatif)",
      none: "Aucune ressource sur ce dossier.",
    },
    journal: {
      title: "Journal de contact",
      desc: "Chaque prise de contact est un enregistrement daté — le message réel reste dans WhatsApp / SMS.",
      add: "Consigner un contact",
      channel: "Canal",
      channels: {
        call: "Appel",
        sms: "SMS",
      ...
      summary: "Résumé",
      seemed: "Impression (facultatif)",
      seemedPlaceholder: "Comment la personne semblait…",
      none: "Aucun contact consigné.",
    },
    evaluations: {
      title: "Évaluations",
      desc: "Grilles standardisées (PHQ-9, GAD-7) et structure d'épuisement professionnel — saisie manuelle, comme les autres grilles d'Eyla.",
      phq9: "PHQ-9 (0–27)",
      gad7: "GAD-7 (0–21)",
      burnoutShell: "Grille épuisement (structure MBI — saisie manuelle, aucun item propriétaire reproduit)",
      openAnalyse: "Saisir dans l'espace d'analyse",
    },
    rapport: {
      title: "Rapport direction",
      desc: "Synthèse agrégée et anonymisée pour la direction — aucune donnée individuelle, aucun nom, aucune note clinique.",
      window: "Période",
      print: "Imprimer",
      copy: "Copier",
      copied: "Copié.",
      empty: "Aucune donnée à agréger pour le moment.",
    },
    safety: {
      title: "Sauvegarde des données",
      desc: "Les données vivent dans ce navigateur uniquement. Exportez régulièrement et conservez le fichier en lieu sûr (chiffré) — il s'agit de données de santé mentale de collaborateurs.",
      export: "Exporter les données (JSON)",
      import: "Importer une sauvegarde",
      importSuccess: "Sauvegarde restaurée.",
      importError: "Fichier invalide — aucune donnée modifiée.",
    },
  },
